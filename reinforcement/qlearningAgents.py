...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        # print x for x in self.featExtractor.getFeatures(state, action).values()
        ...
        for feature in self.featExtractor.getFeatures(state, action):
            value += self.weights[feature] * self.featExtractor.getFeatures(state, action)[feature]
        return value
        # util.raiseNotDefined()
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature in self.featExtractor.getFeatures(state, action):
            ...
            # print self.weights[featureValue]
        # util.raiseNotDefined()
