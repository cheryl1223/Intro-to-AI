...
def fillObsCPT(bayesNet, gameState):
    ...
    houseDict = {bottomLeftPos:BOTTOM_LEFT_VAL,topLeftPos:TOP_LEFT_VAL,bottomRightPos:BOTTOM_RIGHT_VAL,topRightPos:TOP_RIGHT_VAL}
    ...
    for housePos in gameState.getPossibleHouses():
        for obsPos in gameState.getHouseWalls(housePos):
            ...
            for assignment in obsFactor.getAllPossibleAssignmentDicts():
                if assignment[FOOD_HOUSE_VAR] == houseDict[housePos]:
                ...
                elif assignment[GHOST_HOUSE_VAR] == houseDict[housePos]:
                    if assignment[obsVar] == RED_OBS_VAL:
